...
public class InvestigationNoteCreatedEvent extends Event {
    ...
    public InvestigationNoteCreatedEvent(IInvestigation investigation, IInvestigationNote investigationNote) {
